...
const projects: InfoCardProps[] = [
  ...
  {
    title: 'SG2042/SG2044/TH1520/DP1000 Linux 内核',
    title_en: 'SG2042/SG2044/TH1520/DP1000 Linux kernel',
    logo: '/img/github-mark.svg',
    subtitle: 'revyos/linux',
    subtitle_en: 'revyos/linux',
    description: '适用于 SG2042/SG2044/TH1520/DP1000 芯片的 Linux kernel',
    description_en: 'Linux kernel for SG2042/SG2044/TH1520/DP1000',
    link: 'https://github.com/revyos/linux',
    category: ProjectCategory.Kernel,
  },
  {
  ...
  {
    title: 'SG2042/4 系统镜像构建脚本',
    title_en: 'SG2042/4 System Image Build Scripts',
    logo: '/img/github-mark.svg',
    subtitle: 'revyos/mkimg-sg2042',
    subtitle_en: 'revyos/mkimg-sg2042',
    description: 'SG2042/4 系统镜像构建脚本',
    description_en: 'System image build scripts for SG2042/4',
  ...
  {
    title: 'Firmware SG204x',
    title_en: 'Firmware SG204x',
    logo: '/img/github-mark.svg',
    subtitle: 'revyos/firmware-sg204x',
    description: '适用于 SG204x 的 Firmware(edk2/linuxboot)',
    description_en: 'Firmware(edk2/linuxboot) for SG204x',
    link: 'https://github.com/revyos/firmware-sg204x',
    category: ProjectCategory.Firmware,
  },
  {
    title: 'K230 Linux 内核',
